...
class __TwigTemplate_11d33dac19576e84cce386896b364a99d1dac9e01764fa71f438e8ec0627d1c1 extends Template
{
    private $source;
    private $macros = [];
    ...
    <label>Id reclamation: ";
        // line 8
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["reponse"]) || array_key_exists("reponse", $context) ? $context["reponse"] : (function () { throw new RuntimeError('Variable "reponse" does not exist.', 8, $this->source); })()), "reclamation", [], "any", false, false, false, 8), "id", [], "any", false, false, false, 8), "html", null, true);
        echo "</label>
...
{% block body %}
    ...
    <label>Id reclamation: {{ reponse.reclamation.id }}</label>

    {{ include('reponse/_form.html.twig') }}

    <a href=\"{{ path('reponse_index') }}\">back to list</a>
{% endblock %}
", "reponse/new.html.twig", "C:\\Users\\asus\\Documents\\PidevUserWeb\\templates\\reponse\\new.html.twig");
    }
}
